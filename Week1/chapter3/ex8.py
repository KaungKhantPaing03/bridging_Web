...
locations = ['Osaka','Busan','Seoul','Tokyo']
print(locations)
...
#Using reverse() to change the order of list.
locations.reverse()
print(f"Reverse: {locations}")
#Using reverse() to change the order of list again.
locations.reverse()
print(f"Reverse Again: {locations}")
locations.sort()#ascedning order
print(f"After sorting in alphabetical order: {locations}" )
locations.sort(reverse=True) #Descending Order
print(f"AFter sorting in Reverse: {locations}" )
